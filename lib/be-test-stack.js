...
class BeTestStack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        paymentsResource.addMethod('POST', new aws_apigateway_1.LambdaIntegration(createPaymentFunction));
        const getPaymentFunction = this.createLambda('getPayment', 'src/getPayment.ts');
        paymentsTable.grantReadData(getPaymentFunction);
        specificPaymentResource.addMethod('GET', new aws_apigateway_1.LambdaIntegration(getPaymentFunction));
